...
const initialConfig = {
  ...
  description: '24-Hour Non-Stop Online Hackathon Phase & Code Auditing',
  startDate: '2026-10-24',
  startTime: '09:00',
  endDate: '2026-10-25',
  endTime: '09:00',
  durationHours: 24,
  registrationCutoff: '2026-10-23T23:59:00',
  submissionDeadline: '2026-10-25T09:00:00',
...
export function useVirtualRoundControl() {
  ...
  const executeConfirmedAction = useCallback(() => {
    ...
    switch (action) {
      ...
      case 'PAUSE_ROUND':
        setStatus('Paused');
        toast.error('⏸️ Virtual Round has been PAUSED.');
        setActivityLogs((prev) => [
      ...
      case 'RESUME_ROUND':
        setStatus('Live');
        toast.success('▶️ Virtual Round RESUMED!');
        setActivityLogs((prev) => [
