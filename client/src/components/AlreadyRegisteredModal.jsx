...
export default function AlreadyRegisteredModal({
 ...
 className="relative z-10 w-full max-w-lg max-h-[90vh] overflow-y-auto overflow-x-hidden rounded-2xl sm:rounded-3xl bg-[#030712] border border-cyan-500/30 p-5 sm:p-8 shadow-[0_0_50px_rgba(6,182,212,0.2)] text-white space-y-5 sm:space-y-6 my-4"
 >
 ...
 <button
 onClick={onClose}
 className="absolute top-3 right-3 sm:top-4 sm:right-4 p-2 rounded-full text-slate-400 hover:text-white hover:bg-slate-900/80 transition-colors cursor-pointer touch-manipulation"
 ...
 <div className="flex flex-col items-center text-center space-y-3 sm:space-y-4 pt-2">
 <div className="relative inline-flex items-center justify-center">
 <div className="absolute inset-0 rounded-full bg-emerald-500/20 blur-xl animate-pulse" />
 <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gradient-to-tr from-emerald-500 via-teal-400 to-cyan-500 text-slate-950 flex items-center justify-center shadow-lg shadow-emerald-500/30 relative z-10">
 <HiShieldCheck className="w-9 h-9 sm:w-12 sm:h-12 text-slate-950" />
 </div>
 </div>

 <div className="space-y-2">
 <div className="inline-flex items-center space-x-1.5 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-400/30 text-emerald-400 text-[10px] sm:text-xs font-bold tracking-wider">
 ...
 <span className="text-[11px] text-cyan-400 uppercase font-bold tracking-wider">
 ...
 <div>
 <span className="text-slate-500 block text-[10px] uppercase">Team ID</span>
 <span className=" font-bold text-cyan-300 text-base">{teamData.teamId || 'HS2026-REG'}</span>
 </div>
 <div>
 <span className="text-slate-500 block text-[10px] uppercase">Team Name</span>
 ...
 <span className="text-slate-500 block text-[10px] uppercase">Team Leader</span>
