...
export default function AdminDashboard() {
  ...
  // Restrict access if not admin email
  if (!hasAccess) {
    return (
    ...
    <div className="space-y-8">
      ...
      <div className="glass-card rounded-3xl p-6 sm:p-8 border border-cyan-500/30 bg-gradient-to-r from-cyan-950/40 via-slate-900/90 to-purple-950/40 shadow-2xl space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <span className="px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-400/40 text-cyan-300 text-sm font-bold shrink-0">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="glass-card p-6 rounded-2xl border border-slate-800 hover:border-cyan-500/40 transition-all space-y-2">
          <div className="flex items-center justify-between text-cyan-400">
            ...
            <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-cyan-500/10 border border-cyan-500/30">
              TEAMS
            </span>
          </div>
        ...
        <div className="glass-card p-6 rounded-2xl border border-slate-800 hover:border-cyan-500/40 transition-all space-y-2">
          <div className="flex items-center justify-between text-indigo-400">
            ...
            <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-indigo-500/10 border border-indigo-500/30">
              PARTICIPANTS
            </span>
          </div>
        ...
        <div className="glass-card p-6 rounded-2xl border border-slate-800 hover:border-cyan-500/40 transition-all space-y-2">
          <div className="flex items-center justify-between text-purple-400">
            ...
            <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-purple-500/10 border border-purple-500/30">
              INSTITUTIONS
            </span>
          </div>
        ...
        <div className="glass-card p-6 rounded-2xl border border-slate-800 hover:border-cyan-500/40 transition-all space-y-2">
          <div className="flex items-center justify-between text-emerald-400">
            ...
            <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-emerald-500/10 border border-emerald-500/30">
              LATEST
            </span>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-gradient-to-r from-cyan-950/50 to-indigo-950/50 border border-cyan-500/30 mb-4 space-y-2">
            <div className="flex items-center space-x-3">
              ...
              <div className="overflow-hidden">
                ...
                <span className="text-[11px] text-cyan-300 block truncate">
                  {ADMIN_EMAIL}
                </span>
              </div>
            </div>
