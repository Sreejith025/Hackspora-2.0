...
export default function ResourcesTab() {
 ...
 <span className="text-[10px] bg-slate-900 px-2 py-0.5 rounded text-slate-400">GITHUB</span>
 </div>
 ...
 <span className="text-[10px] bg-indigo-500/10 px-2 py-0.5 rounded text-indigo-300">$100 CREDITS</span>
 </div>
 ...
 <div className="p-2 rounded-lg bg-slate-900 text-[11px] text-cyan-300 border border-slate-800 select-all">
 ...
 <span className="text-[10px] bg-purple-500/10 px-2 py-0.5 rounded text-purple-300">DEPLOY</span>
 </div>
