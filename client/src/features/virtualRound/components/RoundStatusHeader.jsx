...
export default function RoundStatusHeader({
  ...
  const getStatusBadge = () => {
    switch (status) {
      case 'Live':
        return (
          <div className="flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-cyan-500/10 border border-cyan-400/50 text-cyan-300 text-xs font-mono font-bold shadow-[0_0_20px_rgba(56,189,248,0.25)]">
      ...
      case 'Paused':
        return (
          <div className="flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-amber-500/10 border border-amber-400/50 text-amber-300 text-xs font-mono font-bold">
      ...
      case 'Ended':
        return (
          <div className="flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-rose-500/10 border border-rose-400/50 text-rose-300 text-xs font-mono font-bold">
      ...
      default:
        return (
          <div className="flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-slate-800 border border-slate-700 text-slate-300 text-xs font-mono font-bold">
    ...
    <div className="glass-card rounded-2xl p-6 border border-slate-800/80 shadow-2xl space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
        ...
        <div className="lg:col-span-5 p-5 rounded-2xl bg-slate-950/80 border border-slate-800 flex flex-col items-center justify-center text-center space-y-2 relative overflow-hidden">
          <div className="text-[10px] font-mono font-bold uppercase tracking-widest text-slate-400 flex items-center space-x-1">
            <HiClock className="w-3.5 h-3.5 text-cyan-400" />
            <span>Virtual Round Time Remaining</span>
          </div>

          <div className="flex items-center space-x-3 font-mono font-black text-4xl sm:text-5xl text-white tracking-wider text-glow-ice py-1">
        ...
        <div className="lg:col-span-7 grid grid-cols-2 sm:grid-cols-4 gap-3.5">
          <motion.div whileHover={{ y: -2 }} className="p-4 rounded-xl bg-slate-900/80 border border-slate-800">
            <div className="flex items-center justify-between text-slate-400 mb-2">
              ...
              <span className="text-[9px] font-mono font-bold text-cyan-400">LIVE</span>
            </div>
          ...
          <motion.div whileHover={{ y: -2 }} className="p-4 rounded-xl bg-slate-900/80 border border-slate-800">
            <div className="flex items-center justify-between text-slate-400 mb-2">
              ...
              <span className="text-[9px] font-mono font-bold text-indigo-400">ACTIVE</span>
            </div>
          ...
          <motion.div whileHover={{ y: -2 }} className="p-4 rounded-xl bg-slate-900/80 border border-slate-800">
            <div className="flex items-center justify-between text-slate-400 mb-2">
              ...
              <span className="text-[9px] font-mono font-bold text-emerald-400">SUBMITTED</span>
            </div>
          ...
          <motion.div whileHover={{ y: -2 }} className="p-4 rounded-xl bg-slate-900/80 border border-slate-800">
            <div className="flex items-center justify-between text-slate-400 mb-2">
              ...
              <span className="text-[9px] font-mono font-bold text-purple-400">{submissionProgress}%</span>
            </div>
      ...
      <div className="space-y-1.5 pt-2">
        <div className="flex justify-between text-xs font-semibold text-slate-300">
          ...
          <span className="font-mono text-cyan-400">{metrics.submissionsReceived} / {metrics.totalTeams} Teams ({submissionProgress}%)</span>
        </div>
