    ...
    <header className="sticky top-0 z-40 w-full bg-slate-950/85 backdrop-blur-xl border-b border-slate-800/80 px-4 sm:px-6 py-3 shadow-xl shadow-cyan-950/20">
      <div className="max-w-[1600px] mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3 sm:space-x-4">
          ...
          <div className="hidden sm:flex items-center space-x-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-400/40 text-cyan-300 text-xs font-mono font-bold">
        ...
        <div className="flex items-center space-x-3">
          ...
          {submission.isSubmitted ? (
            <span className="px-2.5 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/40 text-emerald-400 text-[11px] font-mono font-bold">
              ✓ SUBMITTED
            </span>
          ) : (
            <span className="px-2.5 py-1 rounded-full bg-amber-500/10 border border-amber-500/40 text-amber-300 text-[11px] font-mono font-bold">
              DRAFT MODE
            </span>
          )}
