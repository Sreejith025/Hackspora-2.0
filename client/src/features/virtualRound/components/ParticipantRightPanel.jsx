    ...
    <div className="space-y-6">
      ...
      <div className="glass-card rounded-2xl p-6 border border-slate-800/80 shadow-2xl flex flex-col items-center justify-center text-center space-y-4">
        <div className="flex items-center justify-between w-full border-b border-slate-800/80 pb-3">
          ...
          <span className={`px-2 py-0.5 rounded-full text-[9px] font-mono font-bold border ${timerColors.badgeBg}`}>
        ...
        <div className="w-full p-2.5 rounded-xl bg-slate-950/80 border border-slate-800 flex items-center justify-between text-xs">
          ...
          <span className="font-mono text-cyan-400 font-bold flex items-center space-x-1 text-[11px]">
      ...
      <div className="glass-card rounded-2xl p-5 border border-slate-800/80 shadow-2xl space-y-3">
        ...
        <div className="p-3.5 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2 text-xs">
          <div className="flex justify-between">
            ...
            <span className="font-mono font-bold text-slate-200">{submission.githubRepoUrl ? 'Attached' : 'Missing'}</span>
          </div>
          <div className="flex justify-between">
            <span className="text-slate-400">Demo Video:</span>
            <span className="font-mono font-bold text-slate-200">{submission.demoVideoUrl ? 'Attached' : 'Missing'}</span>
          </div>
          <div className="flex justify-between">
      ...
      <div className="glass-card rounded-2xl p-5 border border-slate-800/80 shadow-2xl space-y-3">
        ...
        <textarea
          ...
          className="w-full p-3 bg-slate-950/80 border border-slate-800 rounded-xl text-xs text-slate-200 font-mono placeholder-slate-600 focus:outline-none focus:border-cyan-400"
        />
      </div>
