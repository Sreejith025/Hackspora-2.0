          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 pt-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-sm text-slate-100 font-mono uppercase placeholder-slate-500 focus:outline-none focus:border-cyan-400"
              />
              {errors.code && (
