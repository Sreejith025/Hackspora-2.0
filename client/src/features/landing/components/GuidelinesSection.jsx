              ...
              >
                ...
                <div className="p-5 rounded-2xl bg-amber-500/10 border border-amber-500/30 text-amber-200 text-xs space-y-2">
                  ...
                  <p className="leading-relaxed">
                    The registration fee of <strong className="text-white">₹250 per participant</strong> will be collected <strong>ONLY</strong> after a team is shortlisted in the Virtual Screening Round (Round 1) and confirms participation for the Offline Grand Finale (Round 2).
                  </p>
                </div>
              </motion.div>
            )}
