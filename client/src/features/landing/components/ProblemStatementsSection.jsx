...
export default function ProblemStatementsSection() {
 ...
 <div className="pt-4 border-t border-white/20 flex items-center justify-between text-xs text-amber-400 filter blur-[6px] select-none opacity-40 pointer-events-none">
