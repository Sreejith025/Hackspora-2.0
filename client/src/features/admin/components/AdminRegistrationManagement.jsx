...
export default function AdminRegistrationManagement() {
 ...
 if (status === 'Verified') {
 return (
 <span className="inline-flex items-center space-x-1 px-2.5 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-[11px] font-bold">
 ...
 if (status === 'Pending') {
 return (
 <span className="inline-flex items-center space-x-1 px-2.5 py-1 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-400 text-[11px] font-bold">
 ...
 return (
 <span className="inline-flex items-center space-x-1 px-2.5 py-1 rounded-full bg-rose-500/10 border border-rose-500/30 text-rose-400 text-[11px] font-bold">
 ...
 <div>
 <div className="flex items-center space-x-2 text-cyan-400 text-xs font-bold tracking-widest uppercase mb-1">
 ...
 >
 <div className="px-3 py-1.5 text-[10px] text-cyan-400 uppercase font-bold tracking-wider border-b border-slate-800">
 EXPORTS & REPORTS
 </div>
 <button
 ...
 <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Total Participants</span>
 ...
 <div className="flex items-center justify-between">
 <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Total Teams</span>
 ...
 <div className="flex items-center justify-between">
 <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Verified Teams</span>
 ...
 <span className="text-[11px] text-emerald-300/80 block ">Approved for Hackathon</span>
 </div>
 ...
 <div className="flex items-center justify-between">
 <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Avg Team Size</span>
 ...
 <div className="flex items-center justify-between">
 <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Top College</span>
 ...
 className="px-3 py-1.5 rounded-lg text-slate-400 hover:text-white bg-slate-900 hover:bg-slate-800 border border-slate-800 transition-colors text-[11px] "
 >
 Reset Filters
 </button>
 <button
 onClick={() => handleDownloadExcel(filteredTeams, 'Filtered_Hackspora_Teams.xlsx')}
 className="px-3 py-1.5 rounded-lg text-cyan-300 hover:text-white bg-cyan-500/10 hover:bg-cyan-500/20 border border-cyan-500/30 transition-colors text-[11px] font-bold flex items-center space-x-1"
 >
 ...
 >
 <div className="flex items-center space-x-2">
 <span className="w-6 h-6 rounded-full bg-cyan-400 text-slate-950 font-bold text-[11px] flex items-center justify-center">
 {selectedIds.length}
 </span>
 <span className="font-bold text-white ">Teams Selected</span>
 </div>
 ...
 <thead>
 <tr className="bg-slate-950/90 text-slate-400 text-[10px] uppercase tracking-wider border-b border-slate-800">
 ...
 {/* Squad Members */}
 <td className="py-3.5 px-4">
 <span className="inline-flex items-center space-x-1 px-2.5 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/30 text-indigo-300 text-[11px] font-bold">
 ...
 <div>
 <div className="flex items-center space-x-2">
 <span className="text-xs font-bold text-cyan-300 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-400/30">
 {selectedTeam.teamId}
 </span>
 ...
 <span className="text-[10px] text-cyan-300">👑 Primary Contact</span>
 </div>

 <div className="grid grid-cols-2 gap-4 text-xs">
 <div>
 <span className="text-slate-500 block uppercase text-[10px]">Leader Name</span>
 ...
 <span className=" text-slate-200">{selectedTeam.leaderEmail}</span>
 </div>
 <div>
 ...
 <div>
 <span className="text-slate-500 block uppercase text-[10px]">Course & Branch</span>
 <span className="font-semibold text-slate-200">{selectedTeam.course} - {selectedTeam.branch}</span>
 </div>
 <div>
 <span className="text-slate-500 block uppercase text-[10px]">Year & Location</span>
 ...
 <span className="text-[11px] text-slate-400 ">Total Team Size: 1 + {selectedTeam.members?.length || 0}</span>
 </div>
 ...
 <span className="w-5 h-5 rounded-full bg-slate-800 text-cyan-400 text-[10px] flex items-center justify-center">
 {idx + 1}
 </span>
 ...
 <div><span className="text-slate-500 ">College:</span> {m.collegeName}</div>
 <div><span className="text-slate-500 ">Branch:</span> {m.branch}</div>
 </div>
 ...
 target="_blank"
 rel="noreferrer"
 className="text-cyan-400 hover:underline text-[11px] inline-flex items-center space-x-1"
 >
 ...
 <div>
 <label className="block text-slate-400 uppercase text-[10px] mb-1">Team Name *</label>
 <input
 type="text"
 name="teamName"
 ...
 <div>
 <label className="block text-slate-400 uppercase text-[10px] mb-1">Status</label>
 <select
 name="status"
 ...
 <div>
 <label className="block text-slate-400 uppercase text-[10px] mb-1">Leader Name *</label>
 <input
 type="text"
 name="leaderName"
 ...
 <div>
 <label className="block text-slate-400 uppercase text-[10px] mb-1">Leader Email *</label>
 <input
 type="email"
 name="leaderEmail"
 ...
 <div>
 <label className="block text-slate-400 uppercase text-[10px] mb-1">Leader Phone *</label>
 <input
 type="text"
 name="leaderPhone"
 ...
 <div>
 <label className="block text-slate-400 uppercase text-[10px] mb-1">College Name *</label>
 <input
 type="text"
 name="collegeName"
 ...
 <div>
 <label className="block text-slate-400 uppercase text-[10px] mb-1">Course</label>
 <input
 type="text"
 name="course"
 ...
 <div>
 <label className="block text-slate-400 uppercase text-[10px] mb-1">Branch / Dept *</label>
 <input
 type="text"
 name="branch"
 ...
 <div>
 <label className="block text-slate-400 uppercase text-[10px] mb-1">Year</label>
 <select
 name="year"
 ...
 <div>
 <label className="block text-slate-400 uppercase text-[10px] mb-1">City</label>
 <input
 type="text"
 name="city"
